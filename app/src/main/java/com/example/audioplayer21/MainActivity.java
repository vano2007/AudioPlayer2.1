package com.example.audioplayer21;
...
public class MainActivity extends AppCompatActivity implements Runnable{
    ...
    // обработка нажатия кнопки
        ...
        fabForward.setOnClickListener(listener); // создание слущателя нажатия кнопки fabForward (перемотки вперед)
    ...
    public void playSong() {
        try { // обработка исключения на случай отстутствия файла
            ...
            if (!wasPlaying) {
                ...
                metaData += "\n" + mediaMetadata.extractMetadata(MediaMetadataRetriever.METADATA_KEY_TITLE); // добавление название трека
